...
class RemainingCoverageTest {
    ...
    fun `BroadcastsViewModel importAndBroadcast`() = runTest {
        ...
        viewModel.importAndBroadcast(uri, context, null)
        advanceUntilIdle()
    ...
    fun `BroadcastsViewModel deleteBroadcast`() = runTest {
        ...
        val broadcast = BroadcastEntity("del1", "test.txt", null, "text/plain", "/path", "hash", 100, 100, 1, "pk", "sk", "sig", Role.ORIGINATOR, 0, 0)
    ...
    fun `SubscriptionsViewModel addSubscription`() = runTest {
        ...
        viewModel.addSubscription("sub1", validPk, null, "name1")
        advanceUntilIdle()
    ...
    fun `SubscriptionsViewModel deleteSubscription`() = runTest {
        ...
        val sub = SubscriptionEntity("sub2", "pk", "f", null, null, null, 0, null, null, null)
