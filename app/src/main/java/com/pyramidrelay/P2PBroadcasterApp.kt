...
class P2PBroadcasterApp : Application() {
    ...
    override fun onCreate() {
        ...
        val transferMutex = kotlinx.coroutines.sync.Mutex() // Only one transfer at a time
        blePeripheralService = BlePeripheralService(this, transferMutex)
        syncEngine = SyncEngine(
            this, broadcastDao, subscriptionDao, cryptoService, fileService,
            bleCentralService, blePeripheralService, notificationService, transferMutex
        )
